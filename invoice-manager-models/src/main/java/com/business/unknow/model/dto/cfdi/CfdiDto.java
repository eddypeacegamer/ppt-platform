...
public class CfdiDto implements Serializable {
	...
	public RelacionadoDto getRelacionado() {
		return relacionado;
	}

	public void setRelacionado(RelacionadoDto relacionado) {
	...
	public String toString() {
		return "CfdiDto [id=" + id + ", version=" + version + ", serie=" + serie + ", folio=" + folio + ", sello="
				...
				+ lugarExpedicion + ", conceptos=" + conceptos + ", complemento=" + complemento + ", relacionado="
				+ relacionado + ", emisor=" + emisor + ", receptor=" + receptor + "]";
	}
