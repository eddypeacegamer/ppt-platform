...
public class PagoDto implements Serializable {
	...
	public String toString() {
		return "PagoDto [id=" + id + ", folio=" + folio + ", moneda=" + moneda + ", tipoDeCambio=" + tipoDeCambio
				+ ", banco=" + banco + ", monto=" + monto + ", statusPago=" + statusPago + ", revision1=" + revision1
				+ ", revision2=" + revision2 + ", comentarioPago=" + comentarioPago + ", tipoPago=" + tipoPago
				+ ", formaPago=" + formaPago + ", fechaPago=" + fechaPago + ", documento=" + documento
