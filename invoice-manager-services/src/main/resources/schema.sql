...
CREATE TABLE IF NOT EXISTS PAGOS(
  ...
  `FOLIO_PADRE` varchar(50) DEFAULT NULL,
  ...
  `COMENTARIO_PAGO` varchar(250) DEFAULT NULL,
  
  `SOLICITANTE` varchar(50) NOT NULL,
  `REVISION_1` tinyint(4) DEFAULT NULL,
  `REVISION_2` tinyint(4) DEFAULT NULL,
  `REVISOR_1` varchar(50) NOT NULL,
  `REVISOR_2` varchar(50) NOT NULL,
