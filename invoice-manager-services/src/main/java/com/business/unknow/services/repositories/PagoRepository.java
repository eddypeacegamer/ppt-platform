...
public interface PagoRepository extends JpaRepository<Pago, Integer> {
	...
	@Query("select p from Pago p where p.acredor = :acredor and p.statusPago like upper(:status) and p.formaPago like upper(:formaPago) and p.banco like upper(:banco) and p.fechaCreacion between :since and :to")
	...
	@Query("select p from Pago p where p.deudor = :deudor and p.statusPago like upper(:status) and p.formaPago like upper(:formaPago) and p.banco like upper(:banco) and p.fechaCreacion between :since and :to")
