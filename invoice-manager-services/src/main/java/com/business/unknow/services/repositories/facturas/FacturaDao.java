...
public class FacturaDao {
	...
	private static final String COMPLEMENT_BY_FOLIO = "SELECT p.FOLIO AS FOLIO,p.ID_DOCUMENTO AS UUID,cfdi.FECHA,f.RAZON_SOCIAL_EMISOR,f.RFC_EMISOR,f.RAZON_SOCIAL_REMITENTE,f.RFC_REMITENTE,f.TIPO_DOCUMENTO,f.PACK_FACTURACION,"
	...
	private static final String COMPLEMENTS_BY_FOLIOS = "SELECT p.FOLIO AS FOLIO,p.ID_DOCUMENTO AS UUID,cfdi.FECHA,f.RAZON_SOCIAL_EMISOR,f.RFC_EMISOR,f.RAZON_SOCIAL_REMITENTE,f.RFC_REMITENTE,f.TIPO_DOCUMENTO,f.PACK_FACTURACION,"
