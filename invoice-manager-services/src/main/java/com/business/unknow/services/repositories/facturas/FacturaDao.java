...
public class FacturaDao {
	...
	private static final String  INVOICE_BY_FOLIO = "SELECT " + 
			...
			"					cfdi.IMP_TRASLADADOS,cfdi.IMP_RETENIDOS,cfdi.SUB_TOTAL,cfdi.TOTAL,f.SALDO_PENDIENTE,cfdi.METODO_PAGO,cfdi.FORMA_PAGO,cfdi.MONEDA,f.STATUS_PAGO,f.STATUS_FACTURA,f.FECHA_CANCELADO,ctos.CANTIDAD,ctos.CLAVE_UNIDAD,ctos.UNIDAD," + 
	...
	private static final String COMPLEMENT_BY_FOLIO = "SELECT f.FOLIO_PADRE AS FOLIO,p.ID_DOCUMENTO AS UUID,cfdi.FECHA,f.RAZON_SOCIAL_EMISOR,f.RFC_EMISOR,f.RAZON_SOCIAL_REMITENTE,f.RFC_REMITENTE,f.TIPO_DOCUMENTO,f.PACK_FACTURACION,"
			+ "	cfdi.TIPO_COMPROBANTE,cfdi.IMP_TRASLADADOS,cfdi.IMP_RETENIDOS,cfdi.SUB_TOTAL,cfdi.TOTAL,f.SALDO_PENDIENTE,p.MONEDA,p.FORMA_PAGO,cfdi.METODO_PAGO,f.STATUS_PAGO,f.STATUS_FACTURA,f.FECHA_CANCELADO,f.FOLIO AS FOLIO_PAGO,f.UUID AS UUID_PAGO,"
